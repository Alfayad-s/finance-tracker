  ...
  return (
    <section className="space-y-5">
      ...
      <section className="space-y-3 rounded-2xl border border-blue-100 bg-white p-4">
        ...
        <p className="text-sm leading-relaxed text-slate-500">
          Add transactions from an HDFC, SBI, ICICI, Axis, Kotak, or generic CSV or PDF. You
          preview rows first. This does not replace existing data.
        </p>
        <Link
          to="/settings/import"
      ...
      <p className="text-xs leading-relaxed text-slate-400">
        Nothing is uploaded. Bank CSV or PDF import adds transactions. JSON restore
        replaces everything. Keep JSON backups somewhere safe if you switch browsers or
        clear site data.
      </p>
